...
class LEVELDB_EXPORT DB {
 public:
  ...
  virtual std::expected<std::string, Error> Get(
...
// database files, Error::OK() will still be returned masking this failure.
LEVELDB_EXPORT Error DestroyDB(const std::string& name,
